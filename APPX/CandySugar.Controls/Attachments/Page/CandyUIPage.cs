...
namespace CandySugar.Controls
{
    ...
    public class CandyUIPage : ContentPage
    {
        ...
        public ObservableCollection<ICandyAttachment> Attachments { get; set; } = new();
        ...
        private void Attachments_CollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            {
                foreach (ICandyAttachment attachment in e.NewItems)
                {
            ...
            {
                foreach (ICandyAttachment attachment in e.OldItems)
                {
