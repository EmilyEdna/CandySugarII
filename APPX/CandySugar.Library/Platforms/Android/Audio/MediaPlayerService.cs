   ...
   MediaPlayer.IOnPreparedListener
{
    ...
    private void HandleIntent(Intent intent)
    {
        ...
        {
            MediaPlayerServiceBinder.StaticService.OnPlayerPlay?.Invoke(this, EventArgs.Empty);
            //mediaController.GetTransportControls().Play();
        }
        else if (action.Equals(ActionPause))
        {
            MediaPlayerServiceBinder.StaticService.OnPlayerPause?.Invoke(this, EventArgs.Empty);
            //mediaController.GetTransportControls().Pause();
        }
        else if (action.Equals(ActionPrevious))
        {
            MediaPlayerServiceBinder.StaticService.OnPlayerSkipToPrevious?.Invoke(this, EventArgs.Empty);
            //mediaController.GetTransportControls().SkipToPrevious();
        }
        else if (action.Equals(ActionNext))
        {
            MediaPlayerServiceBinder.StaticService.OnPlayerSkipToNext?.Invoke(this, EventArgs.Empty);
...
public class MediaPlayerServiceBinder : Binder
{
    ...
    public static MediaPlayerService StaticService { get; set; }
