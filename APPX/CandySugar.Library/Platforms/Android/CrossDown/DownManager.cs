...
using Android.OS;
using CandySugar.Library.Common.Downs;
using System;
...
{
    public class DownManager : IDownManager
    {
        ...
        {
            return new DownFile(url, headers);
        }
        ...
        public void Abort(IDownloadFile i)
        {
            ...
            file.Status = DownFileStatus.CANCELED;
        ...
        {
            var downloadFile = new DownFile(cursor);
        ...
        void StartDownloadWatcher()
        {
            ...
            _downloadWatcherHandlerRunnable = new Java.Lang.Runnable(() => {
                var downloads = Queue.Cast<DownFile>().ToList();
         ...
         */
        public void UpdateFileProperties(ICursor cursor, DownFile downloadFile)
        {
            ...
            switch ((DownloadStatus)cursor.GetInt(cursor.GetColumnIndex(DownloadManager.ColumnStatus)))
            {
                case DownloadStatus.Successful:
                    ...
                    downloadFile.Status = DownFileStatus.COMPLETED;
                ...
                case DownloadStatus.Failed:
                    ...
                    downloadFile.Status = DownFileStatus.FAILED;
                    RemoveFile(downloadFile);
                    break;
                ...
                case DownloadStatus.Paused:
                    ...
                    downloadFile.Status = DownFileStatus.PAUSED;
                    break;

                case DownloadStatus.Pending:
                    downloadFile.StatusDetails = default(string);
                    downloadFile.Status = DownFileStatus.PENDING;
                    break;

                case DownloadStatus.Running:
                    downloadFile.StatusDetails = default(string);
                    downloadFile.Status = DownFileStatus.RUNNING;
                    break;
            }
        }
