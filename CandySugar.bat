...
@echo 开始自动化发布
cd /d %~dp0
dotnet publish PC\CandySugar.Entry\CandySugar.Entry.csproj -c Release -o ..\CandySugarII\Release -f net6.0-windows10.0.17763.0 --sc true -r win-x64
dotnet publish PC\CandySugar.Advance\CandySugar.Advance.csproj -c Release -o ..\CandySugarII\Release -f net6.0-windows10.0.17763.0 --sc true -r win-x64
...
::xcopy PC\CandySugar.WPF\bin\Debug\net6.0-windows10.0.17763.0\Plugins Release\Plugins /e /s
